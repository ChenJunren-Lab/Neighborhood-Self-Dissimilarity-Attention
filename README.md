...
Overview of our parameter-free Neighborhood Self-Dissimilarity Attention (NSDA).  
- (a) illustrates the NSDA architecture for every element, which uses our proposed Gaussian-kernel-based method to measure element-neighborhood dissimilarity, giving higher weights to elements with more salient differences.  
- (b) depicts the dissimilarity-driven weighting curve generated by NSDA.
- (c) shows the conventional sigmoid-based weighting curve employed in traditional attention mechanisms.  
